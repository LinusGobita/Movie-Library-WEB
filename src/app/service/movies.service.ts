...
export class MoviesService {
  ...
  getCinemaUrl():string {
    console.log(`getCinemaUrl = ${this.baseUrl}/discover/movie?primary_release_date.gte=2021-08-15&primary_release_date.lte=2021-11-22&${this.apiKey}`)
  ...
  getSearchGenresUrl(id: number):string{
    console.log(`getSearchGenresUrl ${this.baseUrl}/genre/${id}/movies?${this.apiKey}`)
